...
# time.sleep(2) // This is not recommended to use in Selenium. Instead, Explicit wait should be used.


driver.find_element(By.CSS_SELECTOR,"input[class='promoCode']").send_keys("rahulshettyacademy")
driver.find_element(By.CSS_SELECTOR,".promoBtn").click()

# Explicit wait is used when we know that only one scenario would need more time (say 10 secs) to execute
# Here allocating 10 secs to Implicit wait will effect the entire code
# time.sleep(10)
